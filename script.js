...
function showPage(id) {
  ...
  if (target) {
    ...
    setTimeout(initScrollMotion, 150); // Re-trigger scroll animations
  }
...
/* ─────────────────────────────────────────────
11. NAVBAR SCROLL SHADOW & SCROLL OBSERVERS
───────────────────────────────────────────── */
...
function initRipple() {
  document.addEventListener('click', e => {
   ...
   ripple.style.cssText = `position:absolute; border-radius:50%; background:rgba(255,255,255,.3); width:10px; height:10px; animation:rippleAnim .6s ease-out forwards; left:${e.clientX - rect.left - 5}px; top:${e.clientY - rect.top - 5}px; pointer-events:none;`;
  ...
  style.textContent = `@keyframes rippleAnim { 0% { transform:scale(0); opacity:1; } 100% { transform:scale(30); opacity:0; } } @keyframes scrollAnim { 0% { opacity:1; transform:translateY(0); } 100% { opacity:0; transform:translateY(12px); } }`;
...
function initServiceCards() {
  document.querySelectorAll('.sh-card').forEach(card => {
   ...
   card.addEventListener('mouseenter', () => {
     overlay.style.background = 'linear-gradient(to top,rgba(10,20,40,.92) 0%,rgba(10,20,40,.5) 50%,rgba(10,20,40,.3) 100%)';
   });
   card.addEventListener('mouseleave', () => { overlay.style.background = ''; });
  });
}
...
/* ─────────────────────────────────────────────
22. INTERACTIVE TABS (NEW)
───────────────────────────────────────────── */
function initInteractiveTabs() {
  document.querySelectorAll('.interactive-tabs').forEach(tabGroup => {
...
/* ─────────────────────────────────────────────
23. SCROLL MOTION OBSERVER (NEW - Framer-like)
───────────────────────────────────────────── */
...
/* ─────────────────────────────────────────────
24. INITIALISE EVERYTHING on DOM ready
───────────────────────────────────────────── */
document.addEventListener('DOMContentLoaded', () => {
  ...
  initChatInput();
  initInteractiveTabs();
  initScrollMotion(); // Framer-like scroll reveals
